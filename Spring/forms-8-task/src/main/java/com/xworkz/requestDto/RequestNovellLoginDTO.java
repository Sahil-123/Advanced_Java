...
@Setter
@ToString
public class RequestNovellLoginDTO {
    ...
    @Pattern(regexp = "^[a-zA-Z\\s]+$", message = "Employment must contain only letters")
    ...
    public RequestNovellLoginDTO() {
        System.out.println("RequestNovellLoginDTO object is created..");
    }
}
